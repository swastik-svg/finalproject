...
import { User, MagFormEntry, RabiesPatient, PurchaseOrderEntry, IssueReportEntry, FirmEntry, QuotationEntry, InventoryItem, Store, DashboardProps, StockEntryRequest, DakhilaPratibedanEntry, DakhilaItem, ReturnEntry, MarmatEntry, DhuliyaunaEntry, LogBookEntry, OrganizationSettings } from './types';
import { db } from './firebase';
import { ref, onValue, set, remove, push, child, update } from "firebase/database";
